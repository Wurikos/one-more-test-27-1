...
import { RawHtml, Section, StackItem, Stack, Override } from "@quarkly/components";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<RawHtml>
			<style place={"endOfHead"} rawKey={"601181203b82557eb2b6f047"}>
			...
			<meta
				...
				content={"новы слова"}
				place={"endOfHead"}
				rawKey={"60118146bc933ddf757cb6a4"}
			/>
			<script place={"endOfBody"} rawKey={"6011815720043ccd7d24330d"}>
				{"alert (\"test\")"}
			</script>
		</RawHtml>
	</Theme>;
